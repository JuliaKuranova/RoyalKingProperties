  ...
  return (
    <>
      <div className="about-us__banner">
        <HeaderImage img={headerImage} className="about-us__banner" />
        <h1 className="h1 about-us__title">
          Premier Real Estate Agency in Dubai – Royal&nbsp;King&nbsp;Properties
        </h1>
      </div>
      ...
      <main className="about-us">
        ...
        <div className="about-us__info section">
          <p className="main-text">
            ...
            in Dubai. With our unwavering commitment to excellence, exceptional
            service, and in-depth market expertise, we have established
            ourselves as a trusted leader in the industry.
          </p>
          <div className="">
          ...
          <div className="">
            <h2 className="h3">
              Contact Royal King Properties - Your Trusted Real Estate Partner
            </h2>
            <p className="main-text">
              Choose Royal King Properties as your trusted real estate partner
              in Dubai. Benefit from our deep market insights, personalized
              service, and access to exclusive properties. Contact us today
              to start a successful real estate journey with Royal King
              Properties.
            </p>
          </div>
        </div>
